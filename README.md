...
| プラットフォーム | ダウンロード |
|-----------------|-------------|
| macOS (Apple Silicon) | [Video-Chapter-Editor-v2.1.12-macOS.dmg](https://github.com/mashi727/rehearsal-workflow/releases/download/v2.1.12/Video-Chapter-Editor-v2.1.12-macOS.dmg) |
| Windows | [Video-Chapter-Editor-v2.1.12-Windows.zip](https://github.com/mashi727/rehearsal-workflow/releases/download/v2.1.12/Video-Chapter-Editor-v2.1.12-Windows.zip) |
