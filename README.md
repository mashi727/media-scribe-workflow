...
| プラットフォーム | ダウンロード |
|-----------------|-------------|
| macOS (Apple Silicon) | [Video-Chapter-Editor-v2.1.3-macOS.dmg](https://github.com/mashi727/rehearsal-workflow/releases/download/v2.1.3/Video-Chapter-Editor-v2.1.3-macOS.dmg) |
| Windows | [Video-Chapter-Editor-v2.1.3-Windows.zip](https://github.com/mashi727/rehearsal-workflow/releases/download/v2.1.3/Video-Chapter-Editor-v2.1.3-Windows.zip) |
