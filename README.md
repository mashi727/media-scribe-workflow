...
| プラットフォーム | ダウンロード |
|-----------------|-------------|
| macOS (Apple Silicon) | [Video-Chapter-Editor-v2.1.19-macOS.dmg](https://github.com/mashi727/rehearsal-workflow/releases/download/v2.1.19/Video-Chapter-Editor-v2.1.19-macOS.dmg) |
| Windows | [Video-Chapter-Editor-v2.1.19-Windows.zip](https://github.com/mashi727/rehearsal-workflow/releases/download/v2.1.19/Video-Chapter-Editor-v2.1.19-Windows.zip) |
