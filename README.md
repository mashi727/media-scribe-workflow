...
| プラットフォーム | ダウンロード |
|-----------------|-------------|
| macOS (Apple Silicon) | [Video-Chapter-Editor-v2.1.20-macOS.dmg](https://github.com/mashi727/rehearsal-workflow/releases/download/v2.1.20/Video-Chapter-Editor-v2.1.20-macOS.dmg) |
| Windows | [Video-Chapter-Editor-v2.1.20-Windows.zip](https://github.com/mashi727/rehearsal-workflow/releases/download/v2.1.20/Video-Chapter-Editor-v2.1.20-Windows.zip) |
