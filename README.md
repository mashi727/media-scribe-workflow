...
| プラットフォーム | ダウンロード |
|-----------------|-------------|
| macOS (Apple Silicon) | [Video-Chapter-Editor-v2.1.8-macOS.dmg](https://github.com/mashi727/rehearsal-workflow/releases/download/v2.1.8/Video-Chapter-Editor-v2.1.8-macOS.dmg) |
| Windows | [Video-Chapter-Editor-v2.1.8-Windows.zip](https://github.com/mashi727/rehearsal-workflow/releases/download/v2.1.8/Video-Chapter-Editor-v2.1.8-Windows.zip) |
